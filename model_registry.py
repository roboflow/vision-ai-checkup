...
from models.hf_endpoint import HFEndpointModel
...
MODEL_REGISTRY = {
    ...
    "SmolVLM2 2.2B": {
        ...
        "in_playground": False,
        "provider": lambda: HFEndpointModel(
            endpoint_url="https://h47lkizdoum3atzv.us-east-1.aws.endpoints.huggingface.cloud",
